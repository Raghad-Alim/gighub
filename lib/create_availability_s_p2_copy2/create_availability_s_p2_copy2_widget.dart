...
import 'create_availability_s_p2_copy2_model.dart';
export 'create_availability_s_p2_copy2_model.dart';

class CreateAvailabilitySP2Copy2Widget extends StatefulWidget {
  const CreateAvailabilitySP2Copy2Widget({
    super.key,
    this.availability,
  });
  ...
  @override
  State<CreateAvailabilitySP2Copy2Widget> createState() =>
      _CreateAvailabilitySP2Copy2WidgetState();
}

class _CreateAvailabilitySP2Copy2WidgetState
    extends State<CreateAvailabilitySP2Copy2Widget> {
  late CreateAvailabilitySP2Copy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAvailabilitySP2Copy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createAvailabilitySP2Copy2UserRecord = snapshot.data!;
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await createAvailabilitySP2Copy2UserRecord.reference
                            .update({
                          ...mapToFirestore(
                            {
