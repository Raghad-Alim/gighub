...
import 'youtube_request_page_copy_model.dart';
export 'youtube_request_page_copy_model.dart';

class YoutubeRequestPageCopyWidget extends StatefulWidget {
  const YoutubeRequestPageCopyWidget({
    super.key,
    required this.spRef,
  ...
  @override
  State<YoutubeRequestPageCopyWidget> createState() =>
      _YoutubeRequestPageCopyWidgetState();
}

class _YoutubeRequestPageCopyWidgetState
    extends State<YoutubeRequestPageCopyWidget> {
  late YoutubeRequestPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YoutubeRequestPageCopyModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final youtubeRequestPageCopyUserRecord = snapshot.data!;
                                      ...
                                      child: FlutterFlowChoiceChips(
                                        options: functions
                                            .getAvailableSlots(
                                                ...
                                                youtubeRequestPageCopyUserRecord
                                                    .availability
                                                    .toList())!
