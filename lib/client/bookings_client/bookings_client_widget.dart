...
class BookingsClientWidget extends StatefulWidget {
  const BookingsClientWidget({super.key});

  @override
  State<BookingsClientWidget> createState() => _BookingsClientWidgetState();
}

class _BookingsClientWidgetState extends State<BookingsClientWidget>
    with TickerProviderStateMixin {
  late BookingsClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingsClientModel());
              ...
              child: Stack(
                children: [
                                  ...
                                  children: [
                                    ListView(
                                      ...
                                      children: [
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      context
                                                                        ...
                                                                        queryParameters:
                                                                          ...
                                                                          'commentPay':
                                                                              serializeParam(
                                                                            listViewBookingRecord.clientComment,
                                                                            ParamType.String,
                                                                          ),
                                                                          'locationPay':
                                                                              serializeParam(
                                                                          ...
                                                                          'pricePay':
                                                                              serializeParam(
                                                                            listViewBookingRecord.price.toDouble(),
                                                                            ParamType.double,
                                                                          ),
                                                                          'clientEmail':
                                                                              serializeParam(
                                                                            listViewBookingRecord.email,
                                                                            ParamType.String,
                                                                          ),
                                                                          'clientFirstName':
                                                                              serializeParam(
                                                                            listViewBookingRecord.clientFirstName,
                                                                            ParamType.String,
                                                                          ),
                                                                          'clientLastName':
                                                                              serializeParam(
                                                                            listViewBookingRecord.clientLastName,
                                                                            ParamType.String,
                                                                          ),
                                                                        }.withoutNulls,
                                                                      );
                                        ...
                                        if (functions.bookingsUpcomingClient(
                                                bookingsClientBookingRecordList
                                                    .map((e) => e.status)
                                                    .toList()) ??
                                            true)
                                          Align(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'start sending requests and book your next service!',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                    ...
                                    Padding(
                                      ...
                                      child: ListView(
                                        ...
                                        children: [
                                          ...
                                          if (functions.bookingsPreviousClient(
                                                  bookingsClientBookingRecordList
                                                      .map((e) => e.status)
                                                      .toList()) ??
                                              true)
                  ...
                  Align(
                    ...
                    child: wrapWithModel(
                      model: _model.navBarclientBookingModel,
                      updateCallback: () => safeSetState(() {}),
                      child: const NavBarclientBookingWidget(),
                    ),
                  ),
                ],
              ),
