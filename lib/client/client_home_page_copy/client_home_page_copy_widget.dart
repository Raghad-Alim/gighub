...
import 'client_home_page_copy_model.dart';
export 'client_home_page_copy_model.dart';

class ClientHomePageCopyWidget extends StatefulWidget {
  const ClientHomePageCopyWidget({super.key});

  @override
  State<ClientHomePageCopyWidget> createState() =>
      _ClientHomePageCopyWidgetState();
}

class _ClientHomePageCopyWidgetState extends State<ClientHomePageCopyWidget> {
  late ClientHomePageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientHomePageCopyModel());
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: const AlignmentDirectional(-0.4, -0.29),
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 5.0, 0.0, 0.0),
                                child: Container(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final serviceProviders =
                                            clientHomePageCopyUserRecordList
                                                .toList();
                                                                      ...
                                                                      Stack(
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(88.0, 23.0, 0.0, 0.0),
                                                                              child: Text(
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(91.0, 47.0, 0.0, 0.0),
                                                                              child: Text(
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(7.0, 110.0, 0.0, 0.0),
                                                                              child: Icon(
                                                                                Icons.star,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              serviceProvidersItem.aveageRating.toString(),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                    color: FlutterFlowTheme.of(context).alternate,
                                                                                    fontSize: 14.0,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              serviceProvidersItem.tatalRating.toString(),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
