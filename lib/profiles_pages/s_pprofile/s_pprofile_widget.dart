...
class SPprofileWidget extends StatefulWidget {
  const SPprofileWidget({super.key});

  @override
  State<SPprofileWidget> createState() => _SPprofileWidgetState();
}

class _SPprofileWidgetState extends State<SPprofileWidget> {
  late SPprofileModel _model;
                            ...
                            child: Row(
                              ...
                              children: [
                                if (valueOrDefault<bool>(
                                    currentUserDocument?.cash, false))
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        10.0, 0.0, 0.0, 0.0),
                                    child: AuthUserStreamWidget(
                                ...
                                if (valueOrDefault<bool>(
                                        currentUserDocument?.cash, false) &&
                                    valueOrDefault<bool>(
                                        currentUserDocument?.sTCpay, false))
