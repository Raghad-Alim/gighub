...
class SPprofileEditCopyWidget extends StatefulWidget {
  const SPprofileEditCopyWidget({super.key});

  @override
  State<SPprofileEditCopyWidget> createState() =>
      _SPprofileEditCopyWidgetState();
}

class _SPprofileEditCopyWidgetState extends State<SPprofileEditCopyWidget> {
  late SPprofileEditCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SPprofileEditCopyModel());
