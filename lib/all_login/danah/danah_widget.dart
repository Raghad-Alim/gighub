...
import 'danah_model.dart';
export 'danah_model.dart';

class DanahWidget extends StatefulWidget {
  const DanahWidget({super.key});

  @override
  State<DanahWidget> createState() => _DanahWidgetState();
}

class _DanahWidgetState extends State<DanahWidget> {
  late DanahModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DanahModel());
