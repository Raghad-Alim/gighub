...
import 'dupplogin_model.dart';
export 'dupplogin_model.dart';

class DupploginWidget extends StatefulWidget {
  const DupploginWidget({super.key});

  @override
  State<DupploginWidget> createState() => _DupploginWidgetState();
}

class _DupploginWidgetState extends State<DupploginWidget> {
  late DupploginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DupploginModel());
