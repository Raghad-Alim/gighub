...
import 'create_account_client_copy_model.dart';
export 'create_account_client_copy_model.dart';

class CreateAccountClientCopyWidget extends StatefulWidget {
  const CreateAccountClientCopyWidget({
    super.key,
    this.place,
    this.location,
  });
  ...
  @override
  State<CreateAccountClientCopyWidget> createState() =>
      _CreateAccountClientCopyWidgetState();
}

class _CreateAccountClientCopyWidgetState
    extends State<CreateAccountClientCopyWidget> {
  late CreateAccountClientCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountClientCopyModel());
                            ...
                            children: [
                              ...
                              FlutterFlowChoiceChips(
                                ...
                                selectedChipStyle: ChipStyle(
                                  backgroundColor: const Color(0x6F9E87BC),
