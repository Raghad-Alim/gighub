...
export 'view_details_upcoming_page_model.dart';

class ViewDetailsUpcomingPageWidget extends StatefulWidget {
  const ViewDetailsUpcomingPageWidget({
    super.key,
  ...
  State<ViewDetailsUpcomingPageWidget> createState() =>
      _ViewDetailsUpcomingPageWidgetState();
}

class _ViewDetailsUpcomingPageWidgetState
    extends State<ViewDetailsUpcomingPageWidget> {
  late ViewDetailsUpcomingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewDetailsUpcomingPageModel());
          ...
          child: Column(
            ...
            children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 0.0),
                            child: Text(
                              'Here are the details for your upcoming service. Please ensure all information is correct and prepare accordingly.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
              ...
              Align(
                alignment: const AlignmentDirectional(-1.0, 0.0),
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(19.0, 10.0, 0.0, 0.0),
                  child: Text(
                    'Booking Details',
